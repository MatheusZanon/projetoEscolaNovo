 ...
 * @author Roni
 */
public class DisciplinaSrv extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            private List<Registros> alunos = new ArrayList<>;
            ...
            Logger.getLogger(DisciplinaSrv.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        for (Disciplina disciplina : lista) {
            listaHTML = listaHTML
                    ...
                    + "<td>" + disciplina.getDescricao()     + "</td>"
                        + "<td><form action=DisciplinaSrv?acao=pre-edicao method='POST'>"
                    + "<input type='hidden' name='id'  value=" + 
                        aluno.getId() + "><input type='submit' value=editar>"
                    + "</form></td>"
                    
                    + "<form action=DisciplinaSrv?acao=exclusao method='POST'>"
